...
const SideBar = () => {
    return <React.Fragment>
        <div className="h-full">
            <ul className="h-full  menu bg-base-200 rounded-box bg-transparent p-0">
                <li>
                ...
                <li>
                    <Link href={''} className="tooltip tooltip-right " data-tip="Details">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    </Link>
                </li>
                <div className="divider divider-vertical m-0  p-0"></div>

                <li>
                    <Link href={''} className="tooltip tooltip-right " data-tip="Stats">
        ...
        <div h-full>
            ...
            <ul className="h-full menu bg-base-200 w-56 rounded-box bg-transparent p-0">
                ...
                {/* <li className=""><Link href={''}>interests</Link></li> */}
                <li className="">
                    <details >
                ...
                <li className="">
                    <details >
                        ...
                        <ul>
                            <li className=""><Link href={''}>user@gmail.com</Link></li>
                            <li className=""><Link href={''}>+3598246359</Link></li>
                        </ul>
                    </details>
                </li>
            </ul>
